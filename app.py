...
SQUAD_ATIVAS = ["Ruan Athaide", "Camila Garcia", "Marlise Borges", "Daiane Habowski", "Yasmine Goulart", "Raissa Silva", "Roger Santos", "Bianca Brasil", "Andressa Marchaki", "Viviane Santos", "Maria Elisa", "Endrio Silva", "Alex Alves", "Franscielle Leal", "Sophie Barbosa", "Bruna Tybusch","Ana Bezerra", "Franciele Silva", "Sarana Zatti" ]
