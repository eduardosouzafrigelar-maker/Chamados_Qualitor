...
def render_corporate_login():
    ...
    <style>
        ...
        /* 3. Centraliza tudo perfeitamente na tela */
        ...
        /* Ícone de Usuário (Primeira Caixa) */
...
if 'usuario' not in st.session_state:
    ...
    with c2:
        # O FORMULÁRIO BLINDADO
        with st.form("login_form", clear_on_submit=False):
            
            # A Logo e Textos alinhados com Flexbox
...
# ===================================================
    ...
    if usuario == "TV":
        ...
        st.write("---")
        st.markdown("### 🏆 Fechamentos da Equipe (Hoje)")
        c7, c8 = st.columns(2)
